...
hl.monitor({
    output = "desc:AOC 24G2W1G4 0x00009CC8",
    mode = "preferred",
    position = "-277x-1080",
    scale = "1"
})
...
hl.binf(mainMod .. " + F", hl.dsp.exec_cmd(firefox))
...
hl.bind(mainMod .. " + SHIFT + E", hl.dsp.exec_cmd(~/.local/bin/rofi-power))
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd(~/.local/bin/rofi-wallpaper))
hl.bind(mainMod .. " + SHIFT + N", hl.dsp.exec_cmd(~/.local/bin/rofi-newfile.sh))
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd(~/.local/bin/float-sdcv-kitty))

hl.bind(mainMod .. " + T", hl.dsp.exec_cmd(~/nix-config/home/waybar/waybar-timer.sh toggle && pkill -RTMIN+5 waybar))
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.exec_cmd(exec, ~/nix-config/home/waybar/waybar-timer.sh reset && pkill -RTMIN+5 waybar))

hl.bind(mainMod .. " + F9", "exec, hyprsunset --temperature 4500")
...
-- Volume
hl.bind("F3", hl.dsp.exec_cmd("pamixer -i 5"), { locked = true, repeating = true })
hl.bind("F2", hl.dsp.exec_cmd("pamixer -d 5"), { locked = true, repeating = true })
hl.bind("F1", hl.dsp.exec_cmd("pamixer -t"),   { locked = true, repeating = true })
